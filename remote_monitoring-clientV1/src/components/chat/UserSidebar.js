        ...
        <header className="chat-profile-header">
          ...
          <div className="header-profile-sidebar">
            <div className="avatar">
              <img src={require("../../assets/img/portrait/small/dummy-profile-pic.png")} alt="User Profile" height="66" width="66" />
              <span
                className={`${
                  status === "offline"
            ...
            <h4 className="chat-user-name">{JSON.parse(localStorage.getItem('context')).first_name+ ' ' + JSON.parse(localStorage.getItem('context')).last_name}</h4>
